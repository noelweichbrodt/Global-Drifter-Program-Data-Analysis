...
%Plot the analysis results
 ...
 hold on;
 plot(1:length(sst2008DOnResponseClean),sst2008DOnResponseClean,1:length(sst2008DOnResponseClean),sst2008EstimateMean,1:length(sst2008DOnResponseClean),sst2008LimitedEstimateMean)
 xlabel('Observations')
 ylabel('SST')
